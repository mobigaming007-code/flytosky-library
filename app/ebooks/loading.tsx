    ...
    <div className="bg-slate-50">
      <section className="bg-gradient-to-br from-orange-600 via-orange-500 to-amber-400 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-6 h-14 w-full max-w-xl animate-pulse rounded-3xl bg-white/30" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="mt-6 mb-12 flex flex-wrap gap-3">
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className="h-10 w-40 animate-pulse rounded-full bg-white shadow-sm ring-1 ring-slate-200"
            />
          ))}
        </div>

        <div className="h-10 w-80 animate-pulse rounded-2xl bg-slate-200" />
        <div className="mt-3 h-5 w-56 animate-pulse rounded-full bg-slate-200" />
